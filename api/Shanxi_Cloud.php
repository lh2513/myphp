...
if($n[$id]) {
$url = "https://rmtzx.daixianxinwen.com/api/media/channelDetail?siteId=1&channelId={$n[$id]}";
$body = json_decode(file_get_contents($url),1)['data']['channelLiveUrl'];
$sm4 = new SM4();
$playurl = $sm4->decrypt(hex2bin(md5('5EKgCrRQCwY4X8V18uPJSHIrnYx6HRwy')),base64_encode(hex2bin($body)));
}
if($m[$id]) {
$url = "https://rmtzx.fysrmt.com/api/media/channelDetail?siteId=1&channelId={$m[$id]}";
$playurl = json_decode(file_get_contents($url),1)['data']['channelLiveUrl'];
}
if($l[$id]) {
$url = "https://rmtzx.bdxrmtzx.com/api/media/channelShare?channelId={$l[$id]}";
$playurl = json_decode(file_get_contents($url),1)['data']['channelLiveUrl'];
}
