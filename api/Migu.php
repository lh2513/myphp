...
function handle_migu_main_request($id) {
    ...
    $url = sprintf(
        "https://webapi.miguvideo.com/gateway/playurl/v1/play/playurlh5?contId=%s&dolby=true&isMultiView=true&xh265=true&os=13&ott=false&rateType=3&salt=%s&sign=%s&timestamp=%s&ua=oneplus-12&vr=true",
        $id, $salt, $sign, $tm
    );
